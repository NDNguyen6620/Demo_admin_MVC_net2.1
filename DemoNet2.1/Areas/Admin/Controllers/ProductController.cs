...
namespace DemoNet2.Areas.Admin.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Image,Price,SalePrice,Content,CategoryId")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Image,Price,SalePrice,Content,CategoryId")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
